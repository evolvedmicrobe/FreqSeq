...
namespace FREQSeq
{
    ...
    {
        private enum LastMove : byte { Diagonal = 1, Insertion = 2, Deletion = 3, None = 4 };
        ...
        public static float GetSmithWatermanScore(string databaseSequence, string querySequence, SimpleSubstitutionMatrix substitutionMatrix)
        {
            ...
            if (querySequence.Length > sizeCutoff) { querySequence = querySequence.Substring(0, sizeCutoff); }
