...
namespace FREQSeq
{
    ...
    public sealed class AlleleCollection
    {
        ...
        public Dictionary<string,TypeToAlign> HashedKMERS;
    ...
    public sealed class AlleleTypeAssigner
    {
        ...
        /// sequences
        /// </summary>
        public readonly Dictionary<string,TypeToAlign> HashedKMERS;
            ...
            if(AssignInexactMatches)
            {
                ...
                if(read.AvgQuality<MinAvgQCScoreToAttemptInexactMatch || read.PercN<=MaxNPercentageToAttemptInExactMatch)
                {
                    ...
                    else
                    {
                        ...
                        var Pos=Res[0];
                        if(Pos.score>=Pos.type.MinScoreForAssignment)
